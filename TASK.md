...
- [x] [Sir Literatus] Review UI/UX of the "Phoenix" Author Page.
- [x] [Sir Literatus] Ensure Kinetic Purity and type safety across `src/`.
- [x] [Sir Literatus] Verify all shadcn components are utilized (prune unused).
